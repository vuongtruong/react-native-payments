...
export class AndroidPaymentResponse extends PaymentResponse {
    constructor(requestId: string, methodName: string, jsonData: string) {
        ...
        super(requestId, methodName, {
            ...
            androidPayToken: AndroidPaymentResponse.parseToken(data.paymentMethodData.tokenizationData.token, data.paymentMethodData.info),
    ...
    private static parseToken(input = '{}', info: {
        cardDetails: string,
        cardNetwork: string,
